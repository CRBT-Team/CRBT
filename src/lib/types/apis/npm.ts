// stolen from https://github.com/npm/types/blob/master/index.d.ts
 ...
 * returned from registry requests with accept header values conianing `application/vnd.npm.install-v1+json`
 */
...
/**
 * Dists are properties of Packument.versions they have all the info you need to download and
...
export interface Dist {
  ...
  shasum: string;
  /** Subresource integrity string! `npm view ssri` https://w3c.github.io/webappsec-subresource-integrity/ */
  integrity?: string;
  ...
  unpackedSize?: number;
  /** Pgp signed package signature https://blog.npmjs.org/post/172999548390/new-pgp-machinery */
