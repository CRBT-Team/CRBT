...
if ("$getObjectProperty[a]" === "") {
    d.object.banner = "";
} else {
    d.object.banner = links.banners + items.banners["$getObjectProperty[a]"].season + "/" + items.banners["$getObjectProperty[a]"].contents;
}]

$createObject[{"a": "$replaceText[$replaceText[$getGlobalUserVar[profile_banner;$get[id]];<banner ;];>;]"}]
