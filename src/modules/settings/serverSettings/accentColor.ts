...
import { renderFeatureSettings, getSettings, strings } from "./settings";
...
export const colorSettings: SettingsMenus = {
  ...
  getComponents: ({ i, backBtn, settings }) => components(
    ...
    row(
      backBtn,
      new ManualColorEditButton({ type: EditableFeatures.accentColor, value: settings.accentColor as string })
