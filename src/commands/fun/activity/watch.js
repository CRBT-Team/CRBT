...
module.exports.command = {
    name: "watch",
    module: "fun",
    aliases: ["watch-together", "yt", "youtube", "yttogether", "w2g", "youtube-together"],
    description_enUS: "Allows you to create a Watch Together activity within a voice channel.",
...
• People who join the activity will not show as "Watching $get[activity]" unless they have their Activity Status enabled.]

$let[activity;Watch Together]
