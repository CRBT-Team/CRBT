...
$else
    ...
    $let[color;$toLowercase[$replaceText[$replaceText[$checkCondition[$getObjectProperty[colors.$get[message]]!=];true;$getObjectProperty[colors.$get[message]]];false;$toLowercase[$message]]]]
    $let[message;$replaceText[$toLowercase[$message]; ;]]
