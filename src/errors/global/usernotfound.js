...
$let[title-enUS;${emojis.error} Couldn't find this user.]
...
$let[title-enUK;${emojis.error} Sorry! We couldn't find this user.]
...
$let[title-frFR;${emojis.error} L'utilisateur est introuvable.]
...
$let[title-esES;${emojis.error} No se ha podido encontrar este usuario.]
...
$let[title-ptBR;${emojis.error} Hmm, não foi possível encontrar este usuário.]
...
$let[title-ru;${emojis.error} Невозможно найти данного пользователя.]
