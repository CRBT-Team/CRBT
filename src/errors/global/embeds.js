...
$let[description2-enUS;> To fix this, go to Server Settings > Roles > CRBT > Perrmissions > Embed Links ${emojis.toggleon}]
...
$let[description2-enUK;> To fix this issue, go to Server Settings > Roles > CRBT > Permissions > Embed Links ${emojis.toggleon}]
...
$let[description2-esES;> Para arreglar esto, ve a Ajustes del servidor > Roles > CRBT > Permisos > Insertar enlaces ${emojis.toggleon}]
...
$let[description2-frFR;> Pour régler cela, allez dans Paramètres du serveur > Roles > CRBT > Permissions > Intégrer des liens ${emojis.toggleon}]
...
$let[description2-ptBR;> To fix this issue, go to Server Settings > Roles > CRBT > Permissions > Embed Links ${emojis.toggleon}]
...
$let[description2-ru;> Чтобы решить данную проблему, нужно зайти в "Настройки сервера" > "Роли" > "CRBT" > "Права текстового канала" > "Встраивать ссылки" ${emojis.toggleon}]
