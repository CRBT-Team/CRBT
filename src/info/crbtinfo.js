...
$replaceText[$replaceText[$replaceText[$username[$clientID];CRBT Rewritten;Beta ${botinfo.build}];CRBT Beta;Beta ${botinfo.build}];CRBT;Stable ${botinfo.version}] | Created by [Clembs](https://clembs.xyz)]
...
$replaceText[$replaceText[$replaceText[$username[$clientID];CRBT Rewritten;Version bêta ${botinfo.build}];CRBT Beta;Version beta ${botinfo.build}];CRBT;Version stable ${botinfo.version}] | Créé par [Clembs](https://clembs.xyz)]
