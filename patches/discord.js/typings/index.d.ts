...
export class CategoryChannel extends GuildChannel {
  ...
  public createChannel<
    T extends Exclude<CategoryChannelTypes, 'GUILD_STORE' | ChannelTypes.GUILD_STORE>
  >(
    name: string,
    options: CategoryCreateChannelOptions & { type: T }
  ): Promise<MappedChannelCategoryTypes[T]>;
  /**
   * @deprecated See [Self-serve Game Selling
   *   Deprecation](https://support-dev.discord.com/hc/en-us/articles/6309018858647) for more information
   */
  public createChannel(
    name: string,
...
export abstract class Channel extends Base {
  ...
  /**
   * @deprecated This will be removed in the next major version, see
...
export class InteractionCollector<T extends Interaction> extends Collector<Snowflake, T> {
  ...
  public on(
    event: 'end',
    listener: (collected: Collection<Snowflake, T>, reason: string) => Awaitable<void>
  ): this;
...
export class Sweepers {
  ...
  public sweepBans(
    filter: CollectionSweepFilter<SweeperDefinitions['bans'][0], SweeperDefinitions['bans'][1]>
  ): number;
  public sweepEmojis(
...
export class VoiceChannel extends TextBasedChannelMixin(BaseGuildVoiceChannel, [
  'lastPinTimestamp',
  'lastPinAt',
]) {
...
> extends BaseManager {
  ...
  public has(
    options: FetchSingleOptions & { permissionId: UserResolvable | RoleResolvable }
  ): Promise<boolean>;
...
export interface ClientEvents extends BaseClientEvents {
  /**
   * @deprecated See [this issue](https://github.com/discord/discord-api-docs/issues/3690) for more
   *   information.
   */
...
export type GuildScheduledEventSetStatusArg<T extends GuildScheduledEventStatus> =
  T extends 'SCHEDULED' ? 'ACTIVE' | 'CANCELED' : T extends 'ACTIVE' ? 'COMPLETED' : never;
...
> = Omit<InteractionCollectorOptions<T>, 'channel' | 'message' | 'guild' | 'interactionType'>;
...
export type GuildTextBasedChannel = Exclude<
  Extract<GuildBasedChannel, TextBasedChannel>,
  ForumChannel
>;
