...
class MessageSelectMenu extends BaseMessageComponent {
   ...
   * @property {boolean} [disabled=false] Disables the select menu to prevent interactions. Default is `false`
   ...
   * @property {string | null} description Optional description to show for this option
   * @property {RawEmoji | null} emoji Emoji to display for this option
  ...
  /**
   * @param {MessageSelectMenu | MessageSelectMenuOptions} [data={}] MessageSelectMenu to clone or
   *   raw data. Default is `{}`
   */
  constructor(data = {}) {
   ...
   *
   * @param {boolean} [disabled=true] Whether this select menu should be disabled. Default is `true`
   * @returns {MessageSelectMenu}
   */
  ...
  /**
   * Sets the minimum number of selections required for this select menu <info>This will default the
   * maxValues to the number of options, unless manually set</info>
   *
   ...
   */
  setType(type) {
    if (!SelectMenuComponentTypes[type])
      throw new TypeError('INVALID_TYPE', 'type', 'SelectMenuComponentType');
   ...
   * Normalizes option input and resolves strings and emojis.
   *
   * @param {...(MessageSelectOptionData | MessageSelectOptionData[])} options The select menu
