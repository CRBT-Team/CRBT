...
export declare enum UserFlags {
  ...
  /**
   * Bot uses only [HTTP
   * interactions](https://discord.com/developers/docs/interactions/receiving-and-responding#receiving-an-interaction)
  ...
  /**
   * User's account has been [quarantined](https://support.discord.com/hc/articles/6461420677527)
...
export interface APIApplicationRoleConnection {
  ...
  /**
   * Object mapping application role connection metadata keys to their `string`-ified value (max
   * 100 characters) for the user on the platform a bot has connected
   */
